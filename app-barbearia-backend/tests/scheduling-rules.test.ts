...
describe("scheduling rules", () => {
  ...
  it("generates slots across multiple barber working ranges", () => {
    const slots = buildAvailableSlots({
      businessHours: { startsAt: "09:30", endsAt: "19:00" },
      barberHours: [
        { startsAt: "14:30", endsAt: "15:10" },
        { startsAt: "17:10", endsAt: "17:50" }
      ],
      busyIntervals: [],
      durationMinutes: 30,
    ...
    assert.deepEqual(slots, ["14:30", "14:40", "17:10", "17:20"]);
  });
